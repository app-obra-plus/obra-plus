    ...
    >
      {
        gerarMarcadoresProximos().map((marker, index) => (
          ...
          >
            <View style={{ backgroundColor: '#ddd', borderColor: "#222", borderStyle: "solid", borderWidth: 1, padding: 6, borderRadius: 1000 }}>
              <Text style={{ color: '#222', fontSize: 12, textAlign: "center", aspectRatio: 1 }}>{(index + 1) % 3 + 1}</Text>
            </View>
          </Marker>
        ))
      }
